...
given_image_path = None
style_reference_image_paths = "images/inputs/stylesArtApp/1808.jpg"
result_prefix = "images/output/aduclt-style"
...
elif "given" in args.init_image:
    x = preprocess_image(given_image_path, True, read_mode=read_mode)
else:
